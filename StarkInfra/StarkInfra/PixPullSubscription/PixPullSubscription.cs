...
namespace StarkInfra
{
    ...
    public partial class PixPullSubscription : Utils.Resource
    {
        ...
        /// <br/>
        /// Create a single PixPullSubscription object from a content string received from a handler listening at
        /// the subscription url. If the provided digital signature does not check out with the StarkInfra
