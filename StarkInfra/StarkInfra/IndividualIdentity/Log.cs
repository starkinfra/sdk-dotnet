...
namespace StarkInfra
{
    public partial class IndividualIdentity
    {
        ...
        ///     <item>Type [string]: type of the IndividualIdentity event which triggered the log creation. ex: "created", "canceled", "processing", "failed", "success"</item>
        ...
        public class Log : Resource
        {
            ...
            /// </list>
            /// </summary>
            public Log(string id, DateTime created, string type, List<String> errors, IndividualIdentity identity) : base(id)
            {
                Card = identity;
                Type = type;
                Created = created;
            ...
            public static (List<Log> page, string pageCursor) Page(string cursor = null, int? limit = null, DateTime? after = null,
                DateTime? before = null, List<string> types = null, List<string> identityIds = null,
                User user = null)
            {
                (string resourceName, Api.ResourceMaker resourceMaker) = Resource();
            ...
            internal static Utils.Resource ResourceMaker(dynamic json)
            {
                ...
                return new Log(id: id, identity: identity, type: type, created: created, errors: errors);
            }
        }
    }
}
