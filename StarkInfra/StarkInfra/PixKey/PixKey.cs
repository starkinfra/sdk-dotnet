...
namespace StarkInfra
{
    ...
    /// Properties:
    /// <list>
    ///     <item>AccountCreated [DateTime]: opening Date or DateTime for the linked account. ex: DateTime(2022, 01, 01)".</item>
    ...
    public partial class PixKey : Resource
    {
        ...
        ///     <list>
        ///         <item>accountCreated [DateTime, default null]: opening Date or DateTime for the account to be linked. ex: "2022-01-01.</item>
        ...
        internal static Resource ResourceMaker(dynamic json)
        {
            ...
            return new PixKey(
                ...
                branchCode: branchCode, name: name, taxID: taxID, id: id, tags: tags, owned: owned, ownerType: ownerType,
