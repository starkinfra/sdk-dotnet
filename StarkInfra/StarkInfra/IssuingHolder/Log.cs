...
namespace StarkInfra
{
    public partial class IssuingHolder
    {
        ...
        public class Log : Resource
        {
            ...
            /// </list>
            /// </summary>
            public Log(string id, DateTime created, string type, IssuingHolder holder) : base(id)
            {
                Created = created;
                Type = type;
                Holder = holder;
            ...
            ///     <item>types [list of strings, default null]: filter retrieved objects by types. ex: new List<string>{ "blocked", "canceled", "created", "unblocked", "updated" }</item>
            ///     <item>holderIds [list of strings, default null]: list of IssuingHolder ids to filter retrieved objects. ex: new List<string>{ "5656565656565656", "4545454545454545" }</item>
            ///     <item>user [Organization/Project object, default null]: Organization or Project object. Not necessary if StarkInfra.Settings.User was set before function call</item>
            /// </list>
            /// <br/>
            /// Return:
            ...
            internal static Resource ResourceMaker(dynamic json)
            {
                ...
                return new Log(id: id, created: created, type: type, holder: holder);
            }
        }
    }
}
