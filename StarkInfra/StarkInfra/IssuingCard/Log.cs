...
namespace StarkInfra
{
    public partial class IssuingCard
    {
        ...
        public class Log : Resource
        {
            ...
            ///     <item>types [list of strings, default null]: filter retrieved objects by types. ex: new List<string>{  "blocked", "canceled", "created", "expired", "unblocked", "updated" }</item>
            ///     <item>cardIds [list of strings, default null]: list of IssuingCard ids to filter retrieved objects. ex: new List<string>{ "5656565656565656", "4545454545454545" }</item>
            ///     <item>user [Organization/Project object, default null]: Organization or Project object. Not necessary if StarkInfra.Settings.User was set before function call</item>
            /// </list>
            /// <br/>
            /// Return:
            ...
            internal static Utils.Resource ResourceMaker(dynamic json)
            {
                ...
                return new Log(id: id, created: created, type: type, card: card);
            }
        }
    }
}
