...
namespace StarkInfra.Utils
{
    public class Rest
    {
        ...
        static string sdkVersion = "0.10.0";
        ...
        public static Response GetRaw(string path, Dictionary<string, object> query, User user, string prefix = null, bool raiseException = true)
        {
        ...
        public static Response PostRaw(Dictionary<string, object> payload, string path, Dictionary<string, object> query, User user, string prefix = null, bool raiseException = true)
        {
        ...
        public static Response PatchRaw(Dictionary<string, object> payload, string path, Dictionary<string, object> query, User user, string prefix = null, bool raiseException = true)
        {
        ...
        public static Response PutRaw(Dictionary<string, object> payload, string path, Dictionary<string, object> query, User user, string prefix = null, bool raiseException = true)
        {
        ...
        public static Response DeleteRaw(Dictionary<string, object> payload, string path, Dictionary<string, object> query, User user, string prefix = null, bool raiseException = true)
        {
