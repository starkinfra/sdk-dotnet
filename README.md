...
StarkInfra`s .NET SDK is available on NuGet as starkinfra 0.12.0

1.1 To install the Package Manager:

```sh
Install-Package starkinfra -Version 0.12.0
```

1.2 To install the .NET CLI:

```sh
dotnet add package starkinfra --version 0.12.0
```

1.3 To install by PackageReference:

```sh
<PackageReference Include="starkinfra" Version="0.12.0" />
```

1.4 To install with Packet CLI:

```sh
packet add starkinfra --version 0.12.0
```
